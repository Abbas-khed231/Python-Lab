...
# Display the DataFrame with missing values detected
print("DataFrame with missing values indicated as True:")
...
'''
Output:
DataFrame with missing values indicated as True:
