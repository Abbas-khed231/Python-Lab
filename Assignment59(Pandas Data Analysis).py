...
of age for each school. Also generate a horizontal bar chart based on the result and explain the conclusion.
...
age_stats.plot(kind='barh', figsize=(10, 6), color=['skyblue', 'lightgreen', 'coral'])
